...
import '../quizzes/quizzes_subjects.dart';

class ChainScreen2 extends StatefulWidget {
  const ChainScreen2(
  ...
  @override
  State<ChainScreen2> createState() => _ChainScreen2State();
}

class _ChainScreen2State extends State<ChainScreen2> {
  @override
  void initState() {
    super.initState();
                  ...
                  child: state is GetChainsLoading
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          itemCount: BlocProvider.of<ChainCubit>(context).chains.length,
                          shrinkWrap: true,
                          physics:
                          ...
                          itemBuilder: (context, index) {
                            return ChainWidget(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          QuizSubjects(
                                            ...
                                            chainId:  BlocProvider.of<ChainCubit>(context).chains[index].chain_id,
                                            sectionName:BlocProvider.of<ChainCubit>(context).chains[index].chain_name ,
                                          ),
                                    ),
                                  );
                                } else {
                              ...
                              courseId:  BlocProvider.of<ChainCubit>(context).chains[index].chain_id,
                              courseName: BlocProvider.of<ChainCubit>(context).chains[index].chain_name,
                              coursePhoto: BlocProvider.of<ChainCubit>(context).chains[index].photo,
                            );
                          },
                        )
                      ],
